defmodule WCoreWeb.Router do
  ...
  # Rotas LiveView protegidas — operador precisa estar autenticado.
  # Usa live_session + on_mount porque plugs de conn não bloqueiam LiveViews
  # após o upgrade para WebSocket (o handshake WS não passa pelo pipeline Plug).
  scope "/", WCoreWeb do
    pipe_through :browser
